...
#[derive(Serialize, Deserialize, Clone, Debug)]
#[serde(rename_all = "kebab-case")]
pub struct HtxCurrencies {
    // Parameter	Data Type	Required	Description
    pub status: String,     // false	status
    pub data: Vec<HtxCurrency>,     // false	data
    #[serde(alias = "ts")]
...
impl HtxCurrencies {
    ...
    where
        F: Fn(&HtxCurrency) -> bool,
    {
        let filtered_data: Vec<HtxCurrency> =
    ...
    pub fn get_currencies(&self) -> Vec<&HtxCurrency> {
